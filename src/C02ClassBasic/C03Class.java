...
////        B부서의 매출
////        10원 매출
//        System.out.println(MyCalculator.sumAcc(10)); // 100 -> 10이 돼야 함.
////        20원 매출
//        System.out.println(MyCalculator.sumAcc(20)); // 120 -> 30이 돼야 함.
...
//    static이 붙어있으면 클래스변수, static붙어있지 않으면 객체변수
    static int total = 0;
...
//    생성자 주된 목적: 객체 생성시 실행되면서, 객체 변수를 초기화하기 위한 목적으로 주로 사용.
